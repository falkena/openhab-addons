...
public class OSHISystemInfo implements SystemInfoInterface {
    ...
    private <T> T getDevice(List<@Nullable T> devices, int index) throws IllegalArgumentException {
    ...
    private <T> T getDevice(T @Nullable [] devices, int index) throws IllegalArgumentException {
    ...
    public String getNetworkIp(int index) throws IllegalArgumentException {
        ...
        return (String) getDevice(network.getIPv4addr(), 0);
    }
