...
public class SystemInfoDriveDiscoveryService extends AbstractDiscoveryService
    ...
    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Set.of(THING_TYPE_DRIVE);
    ...
    protected void startScan() {
        ...
        if (handler != null) {
            ...
            for (int index = 0; index < systemInfo.getHardDriveCount(); index++) {
                ...
                final ThingUID drive = new ThingUID(THING_TYPE_DRIVE, bridgeUID, thingId);
