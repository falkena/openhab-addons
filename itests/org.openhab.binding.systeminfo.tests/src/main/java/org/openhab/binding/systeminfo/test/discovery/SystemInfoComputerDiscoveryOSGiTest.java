...
public class SystemInfoComputerDiscoveryOSGiTest extends JavaOSGiTest {
    ...
    public void setUp() {
        ...
        if (systemInfo != null) {
            systemInfoHandlerFactory.unbindSystemInfo(systemInfo);
        }
    ...
    private void testDiscoveryService(String expectedHostname, String hostname) {
        final SystemInfoComputerDiscoveryService discoveryService = getService(DiscoveryService.class,
                SystemInfoComputerDiscoveryService.class);
        waitForAssert(() -> assertThat(discoveryService, is(notNullValue())));
        ...
        waitForAssert(() -> assertThat(inbox, is(notNullValue())));
        ...
        waitForAssert(() -> assertThat(thing, is(notNullValue())));
        waitForAssert(() -> assertThat("Thing is not initialized.", thing.getStatus(), is(equalTo(ONLINE))));
